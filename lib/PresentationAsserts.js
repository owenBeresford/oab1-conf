...
// https://stackoverflow.com/questions/12470954/javascript-convert-ex-to-px
        ...
        // the following maths is outside of my learning, and is copied from
        ...
        colourDifference: function (t1, t2) {
            // we care abou the difference, not which is more intense
            // keeping each channel seperate, as a strong red is contrasting to a strong yellow
            t2 = t2.substring(1).match(/([A-F0-9]{2})/);
            t1 = t1.substring(1).match(/([A-F0-9]{2})/);
            t3 = [
